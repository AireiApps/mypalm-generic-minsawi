...
@Component({
  selector: "app-tab-preventivemaintenance-new",
  templateUrl: "./tab-preventivemaintenance-new.page.html",
  styleUrls: ["./tab-preventivemaintenance-new.page.scss"],
})
export class TabPreventivemaintenanceNewPage implements OnInit {
    ...
    this.service.getNotificationList(req).then((result) => {
      ...
      if (resultdata.httpcode == 200) {
        ...
        this.extendrunninghoursFlag = String(
          resultdata.extendedrounningkeyinflag
        );
        this.repmnewrecords = resultdata.newcount;
        this.repmpendingrecords = resultdata.pendingcount;
  ...
  clearData() {
    this.ropmnewnotificationlistArr = [];
    this.ropmpendingnotificationlistArr = [];
    this.ropmnewrecords = 0;
    this.ropmpendingrecords = 0;

    this.repmnewnotificationlistArr = [];
    this.repmpendingnotificationlistArr = [];
    this.repmnewrecords = 0;
    this.repmpendingrecords = 0;
  }
