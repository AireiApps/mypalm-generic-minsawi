...
@Component({
  selector: 'app-logsheet-pressstation-edit',
  templateUrl: './logsheet-pressstation-edit.page.html',
  styleUrls: ['./logsheet-pressstation-edit.page.scss'],
})
export class LogsheetPressstationEditPage implements OnInit {
