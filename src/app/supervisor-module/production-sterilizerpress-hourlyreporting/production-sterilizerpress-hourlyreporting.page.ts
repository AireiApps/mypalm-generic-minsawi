...
export class ProductionSterilizerpressHourlyreportingPage implements OnInit {
  ...
  btn_Action(item) {
    if (
      (item.name == "Pressing Station" && this.designationId == 17) ||
      (item.name == "Sterilisation Station" && this.designationId == 18)
    ) {
    ...
    } else if (item.name == "Pressing Station" && this.designationId != 17) {
