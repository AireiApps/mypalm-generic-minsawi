...
@Component({
  selector: 'app-maintenance-history-timeline',
  templateUrl: './maintenance-history-timeline.page.html',
  styleUrls: ['./maintenance-history-timeline.page.scss'],
})
export class MaintenanceHistoryTimelinePage implements OnInit {
  ...
  constructor(private languageService: LanguageService,private route: ActivatedRoute, private router: Router, private maintenanceservice: MaintenanceServiceService, private commonservice: AIREIService) {
  ...
  getNotificationHistory(){
    ...
    this.maintenanceservice.getNotificationTimelineScanDetails(req).then(result => {
      var resultdata: any;
      resultdata = result;
