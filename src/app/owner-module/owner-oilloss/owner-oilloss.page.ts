...
@Component({
  selector: "app-owner-oilloss",
  templateUrl: "./owner-oilloss.page.html",
  styleUrls: ["./owner-oilloss.page.scss"],
})
export class OwnerOillossPage implements OnInit {
  ...
  constructor(
    ...
    //console.log(this.getscreenorientation);
  }
      ...
      if (state.isActive == true) {
        if (this.router.url == "/tabs/taboilloss") {
          ...
          /*if (
            ...
            this.getreport();
          } else if (this.designationid ==16 || this.designationid == 9) {
  ...
  ionViewDidEnter() {
    if (
      this.designationid == 1 ||
      this.designationid == 10 ||
      this.designationid == 12 ||
      this.designationid == 13 ||
      this.designationid == 14 ||
      this.designationid == 22
    ) {
      this.getNotificationCount();
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            if (this.platform.is("android")) {
              appId = "com.airei.milltracking.mypalmgeneric.mikk";
            } else {
              appId = "id1573914314";
            }
