...
export class SegregatenotificationPage implements OnInit {
  ...
  ngOnDestroy() {
    if (this.designationid == 17 || this.designationid == 18) {
  ...
  getNotification() {
    if (this.designationid == "1" || this.designationid == "16") {
      this.filterstatus = "4";
    } else if (
      this.designationid == "17" ||
      this.designationid == "18" ||
