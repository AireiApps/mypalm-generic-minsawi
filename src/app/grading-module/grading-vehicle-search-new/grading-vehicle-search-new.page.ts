...
@Component({
  selector: "app-grading-vehicle-search-new",
  templateUrl: "./grading-vehicle-search-new.page.html",
  styleUrls: ["./grading-vehicle-search-new.page.scss"],
})
export class GradingVehicleSearchNewPage implements OnInit {
  ...
  loadData(pagerefresh: Boolean, pagenum: string, search: Boolean) {
    ...
    this.gradingservice.getVehicleListNew(req).then((result) => {
      let resultdata: any;
      resultdata = result;
